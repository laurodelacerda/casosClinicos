  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved doenca as @doenca" do
        ...
        post :create, {:doenca => { "nomepopular" => "invalid value" }}, valid_session
        assigns(:doenca).should be_a_new(Doenca)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested doenca" do
        ...
        Doenca.any_instance.should_receive(:update_attributes).with({ "nomepopular" => "MyString" })
        put :update, {:id => doenca.to_param, :doenca => { "nomepopular" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the doenca as @doenca" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Doenca.any_instance.stub(:save).and_return(false)
        put :update, {:id => doenca.to_param, :doenca => { "nomepopular" => "invalid value" }}, valid_session
        assigns(:doenca).should eq(doenca)
      end
